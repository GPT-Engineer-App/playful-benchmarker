...
export const handleSingleIteration = async (runs, updateRun, addResult, supabase, toast, gptEngineerTestToken) => {
  ...
  try {
    ...
    const chatResponse = await sendChatMessage(pausedRun.project_id, chatRequest, pausedRun.system_version, gptEngineerTestToken);
