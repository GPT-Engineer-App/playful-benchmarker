...
const SystemVersionSelector = ({ systemVersion, onSystemVersionChange }) => (
  <div>
    <h2 className="text-2xl font-bold mb-4">Select System Version</h2>
    <Select value={systemVersion} onValueChange={onSystemVersionChange}>
...
export default SystemVersionSelector;